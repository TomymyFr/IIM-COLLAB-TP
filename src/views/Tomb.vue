  ...
  <div id="tomb">
    <div id="box" :class="{ musique: rickroll }">
      ...
      <p>
        ...
        vidéos), mais je fais aussi du développement web front.
      </p>
      Un exemple de projet que j'ai réalisé grâce à une API :
      <a href="https://tomymy.fr/rer-a/" class="link">Horaire RER A</a>
    </div>
